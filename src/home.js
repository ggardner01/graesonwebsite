  ...
  render() {
    return (
      ...
      <div className="App">
        ...
        <p className="App-intro">This is one badass motherfucker.</p>
        <PickleRick onrickplay={this.props.onrickplay} pickleplay={this.props.pickleplay}/>
				<h4 className="App-intro">Shout out to my homeboys (Luke)</h4>
